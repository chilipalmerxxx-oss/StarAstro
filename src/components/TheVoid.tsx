...
const AMOR_TEMPLATES: TemplGen = (ch) => {
  ...
  return [
    ...
    { text: `Avec ${rc.elementCounts[rc.dominantElement]} planètes en ${rc.dominantElement}, tu as besoin d'une alchimie spécifique pour aimer. Tu ne negoties pas avec ta nature — elle est ton boussole.`, planet: 'venus', sign: vSign },
